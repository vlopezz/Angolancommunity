(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CloudinaryReactSDK = {}, global.React));
  ...
  ***************************************************************************** */
  ...
  var AdvancedImage = /** @class */ (function (_super) {
      ...
      AdvancedImage.prototype.render = function () {
          ...
          if (isBrowser()) { // On client side render
              return React__default["default"].createElement("img", __assign({ suppressHydrationWarning: true }, otherProps, { ref: this.imageRef }));
          }
          else { // on server side render
              var src = serverSideSrc(this.props.plugins, this.props.cldImg, SDKAnalyticsConstants);
              return React__default["default"].createElement("img", __assign({}, otherProps, { src: src }));
          }
      };
  ...
  var AdvancedVideo = /** @class */ (function (_super) {
      ...
      AdvancedVideo.prototype.render = function () {
          ...
          ;
          return React__default["default"].createElement("video", __assign({}, videoAttrs, { ref: this.attachRef }));
      };
